...
iptables -A INPUT -p tcp --dport 80 -d 172.20.241.30 -m state --state new -j ACCEPT
iptables -A INPUT -p tcp --dport 443 -d 172.20.241.30 -m state --state new -j ACCEPT
iptables -A INPUT -p tcp --dport 80 -d 172.20.241.20 -m state --state new -j ACCEPT
iptables -A INPUT -p tcp --dport 443 -d 172.20.241.20 -m state --state new -j ACCEPT
...
iptables -A OUTPUT -p tcp --dport 80 -d 172.20.241.20 -m state --state new -j ACCEPT 
iptables -A OUTPUT -p tcp --dport 443 -d 172.20.241.20 -m state --state new -j ACCEPT
iptables -A OUTPUT -p tcp --dport 80 -d 172.20.241.30 -m state --state new -j ACCEPT 
iptables -A OUTPUT -p tcp --dport 443 -d 172.20.241.30 -m state --state new -j ACCEPT
